...
| maintainer          | packages                                                                    |
|:--------------------|:----------------------------------------------------------------------------|
| R Core Team         | base, compiler, datasets, graphics, grDevices, methods, stats, tools, utils |
| Yihui Xie           | evaluate, knitr, rmarkdown, xfun                                            |
| Hadley Wickham      | assertthat, dplyr, stringr                                                  |
| Lionel Henry        | purrr, rlang, tidyselect                                                    |
