...
For example, there is a set of geoms for correlation heatmaps and the likes, which can be very useful when inspecting datasets with large numbers of variables:
...
With `geom_heatpoint()`, you can scale the diameter of any character you want by correlation strength.
